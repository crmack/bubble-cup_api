...
class EventInstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_instance" do
    assert_difference("EventInstance.count") do
      post event_instances_url, params: { event_instance: { event_id: @event_instance.event_id, is_tiebreaker: @event_instance.is_tiebreaker } }
    end
  ...
  test "should update event_instance" do
    patch event_instance_url(@event_instance), params: { event_instance: { event_id: @event_instance.event_id, is_tiebreaker: @event_instance.is_tiebreaker } }
